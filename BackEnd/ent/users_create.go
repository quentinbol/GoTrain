...
func (uc *UsersCreate) SetMessagesID(id int) *UsersCreate {
	uc.mutation.SetMessagesID(id)
	return uc
}

// SetNillableMessagesID sets the "messages" edge to the Messages entity by ID if the given value is not nil.
func (uc *UsersCreate) SetNillableMessagesID(id *int) *UsersCreate {
	if id != nil {
		uc = uc.SetMessagesID(*id)
	}
	return uc
}

// SetMessages sets the "messages" edge to the Messages entity.
func (uc *UsersCreate) SetMessages(m *Messages) *UsersCreate {
	return uc.SetMessagesID(m.ID)
}
